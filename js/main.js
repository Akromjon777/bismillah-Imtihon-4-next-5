    ...
    ({ id, name, username, email, address, phone, website, company }) => {
      ...
      let template = `
            <li onclick='getPosts(${id})' class="users-list__item">
                ...
                <a class="users-list__geo-location" href="https://www.google.com/maps/place/${geo.lat}, ${geo.lng}" target="_blank"></a>
                <a class="users-list__socials-tel" href="tel:${phone}"></a>
                <a class="users-list__socials-site" href="https://${website}" target="_blank"></a>
                </div>
...
function renderPostsDom(arr, node) {
  ...
  arr.forEach(({ id, title, body }) => {
    let template = `
          <li class="posts-list__item" onclick='getComments(${id})'>
  ...
  arr.forEach(({ name, email, body }) => {
    let template = `
          <li class="comments-list__item">
            ...
            <a class="comments-list__item-email" href="mailto:${email}" class="email">${email}</a>
